...
const FilmCardContainer = (props) => {
    ...
    const {id, title, description, poster, comments, trailerLink, rating} = props.film;
    ...
    return (
        <FilmCard key={id} title={title} description={description} rating={rating} trailerLink={trailerLink}/>
    );
}
